...
we build an array of characters and print it out in order. 
The values are found least significant digit first,
and printed most significant digit first. 
*/

#define NDIG 32 /*assume max number of digits */


int getnum(void); // function declaration 
...
count = count - 1; //in prep to print
